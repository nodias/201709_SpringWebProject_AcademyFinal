...
<body>
	...
	<div id="contentsArea">
		...
		<section id="titlename" class="qnaBoard">
			...
			<table class="boardTable">
				...
				<c:choose>
					<c:when test="${listcount>0}">
						...
						<c:forEach var="genre" items="${dataList}" varStatus="status">
							<tbody>
								<tr>
									<td><c:out value="${genre.gen_no}" /></td>
									<td><c:out value="${genre.name}" /></td>
									<td><c:out value="${genre.reg_date}" /><a href="./GenreDeleteProcess.jh?delNum=${genre.gen_no}"><button  class="btn btn-danger">삭제</button></a></td>
			...
			<div align="center">
				<table id="boardTableNe"  class="table table-hover">
					<tbody>
